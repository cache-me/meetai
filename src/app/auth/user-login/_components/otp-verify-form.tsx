...
import { verifyOTPInput } from '@/server/api/router/user/user.input'
...
export default function OTPVerificationForm({
  ...
  const form = useForm<z.infer<typeof verifyOTPInput>>({
  ...
  const onSubmit = (values: z.infer<typeof verifyOTPInput>) => {
